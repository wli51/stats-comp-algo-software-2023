...
```{r, eval=FALSE}
# TERMINATES MY R SESSION DUE TO FATAL ERROR EVERY TIME, DON'T RUN
...
The speed of base R is comparable to that of column oriented matrix muliplication in Rcpp. 
