...
The git_experiment direcotry occupies roughly 86K of diskspace after 99 cycles of writing one line, compiling pdf and commits. This disk usage relative to the individual files within the folder, which sums up to around 37K, seemed to be not reasonable. The directory might have been swelled by the git commits by the size of binary files per commit. This explains why git discourages commiting large binary files as they make repo unnecessarily bulky.   
...
https://github.com/wli51/hiperglm
